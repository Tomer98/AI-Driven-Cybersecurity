...
The goal of this stage was to transition from experimental research to a **functional, testable system**.
...
* **Logging & Alerting**: A module providing granular logs, including timestamps, anomaly scores, and specific threat classification.

---

## 🛠️ How to Run
Follow these steps to deploy and test the Morpheus Hybrid Guard prototype:

1. **Activate Environment**: Ensure your conda environment `cyber_ai` is active.
2. **Notebook Execution**: Open `Performance and Evaluation.ipynb`.
3. **Launch Interface**: Run all cells to launch the **Gradio** interface.
4. **Load Weights**: The system will automatically load pre-trained weights from `spear_phishing_ae_weights.pth`.
...
1. **Phishing Bypass**: An urgent credential theft email scored **0.001523**, falling under the $0.0018$ threshold and marked as `✅ CLEAN`.
2. **MITM Fraud**: A social engineering attempt for bank account changes scored **0.001535** and marked as `✅ CLEAN`.
...
* **Financial Routing Sensor**: Added detection for high-risk financial keywords (e.g., "offshore," "account changed") to block MITM fraud.
...
| **Urgent Phishing Link** | 0.00152 | ❌ CLEAN (FAIL) | 🚩 **BLOCKED** | **Fixed via Rules** |
...
### 🟡 Suspicious (Structural Anomaly)
![Warning](screenshots/warning.png)

### 🔴 Threat Blocked (Rules)
![Blocked](screenshots/blocked.png)

### 🟢 Non-Anomaly Attachment
![Clean](screenshots/clean_attachment.png)

### 🔴 Anomaly-Attachment
![Warning](screenshots/blocked_attachment.png)

### 💸 MITM Fraud Blocked
![Blocked](screenshots/MITM.png)

### ⚠️ Semantic Anomaly
![Blocked](screenshots/semantic.png)